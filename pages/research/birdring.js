  ...
  return (
    <PageLayout count={3} prev={'correst'} next={'extractive'}>
      <div className={styles.project}>
        ...
        <div><a href={'https://reniby.github.io/index/index.html'} key={'Site'} target="_blank" rel="noopener noreferrer">Interactive Website</a></div>
        <br></br>
        ...
        <div><a href={'https://www.nyvolcano.org/phreatic'} key={'Phreatic'} target="_blank" rel="noopener noreferrer">PHREATIC!</a></div>
        <br></br>
