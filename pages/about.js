  ...
  return (
    ...
    <div className={styles.about}>
        <div className={styles.aboutCard} key={'Bio'}>
            ...
            They have also received multiple research grants, and given various conference lectures and presentations focused on how biological processes and human-computer interaction influence algorithmic and computer music.`}</p>
